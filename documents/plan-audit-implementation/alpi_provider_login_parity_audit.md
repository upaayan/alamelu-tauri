...
- Fresh verification run during audit: `node --test packages/pi-sdk-driver/test/runtime-supervisor.test.mjs` passed 5 tests; `npx --yes pnpm@10.25.0 --filter @pi-gui/desktop run typecheck` passed; `npx --yes pnpm@10.25.0 --filter @pi-gui/desktop run test:e2e:runner -- apps/desktop/tests/core/provider-settings.spec.ts` passed 6 tests.
