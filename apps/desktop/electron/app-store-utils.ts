...
import { isSystemWorkspacePathOrName } from "../src/workspace-roots";
...
export function buildWorkspaceRecords(
  ...
  return workspaces.map((workspace) => {
    ...
    const specialKind = noRepositoryWorkspacePath && workspace.path === noRepositoryWorkspacePath
      ? "no-repository"
      : isSystemWorkspacePathOrName(workspace.displayName) || isSystemWorkspacePathOrName(workspace.path)
        ? "system"
        : undefined;
