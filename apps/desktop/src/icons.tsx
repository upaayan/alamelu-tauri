...
export function AlameluPiLogoMark() {
  return <img alt="" aria-hidden="true" src={alameluPiLogoUrl} />;
}
...
export function EditIcon() {
  return (
    <Icon>
      <path
        d="M4.4 14.2 5 11l6.7-6.7a1.55 1.55 0 0 1 2.2 0l1.8 1.8a1.55 1.55 0 0 1 0 2.2L9 15l-3.2.6a1.2 1.2 0 0 1-1.4-1.4Z"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.35"
      />
      <path d="m10.8 5.2 4 4" stroke="currentColor" strokeLinecap="round" strokeWidth="1.35" />
    </Icon>
  );
}
